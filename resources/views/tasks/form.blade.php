...
@section('main-panel-content')
    ...
    <div class="uk-grid">
        <div class="uk-width-1-1@s uk-width-1-3@m">
            ...
            <div class="uk-text-meta">Enter artisan command to schedule</div>
        </div>
        <div class="uk-width-1-1@s uk-width-2-3@m">
            <input class="uk-input" placeholder="e.g. abc:run-cronjob" name="command" id="command" value="{{old('command', $task->command)}}" type="text">
